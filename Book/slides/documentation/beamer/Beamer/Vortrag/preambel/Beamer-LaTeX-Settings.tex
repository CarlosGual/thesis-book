...
%%% Doc: ftp://tug.ctan.org/pub/tex-archive/macros/latex/required/figures/understanding_vsn/grfguide.pdf
% Bilder
\usepackage[%
   %final,
...
%     This says âResize all pages to landscape A4 pages, no what their original size was, but shrink the pages
% by 5mm, so that there is a bit of a border around everything.â Naturally, instead of a4paper you can also use
...
%     ï¬les in a pdf document. The package can be used together with both dvips plus ps2pdf and pdflatex,
