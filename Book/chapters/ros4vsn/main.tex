...
% \usepackage{xspace}
% \makeatletter
%\DeclareRobustCommand{\futurelet\@let@token\@onedot}
...
\newcommand{\pointnav}{\textsc{PointNav}\xspace}
\newcommand{\pointnavfull}{PointGoal Navigation\xspace}
\newcommand{\objnav}{\textsc{ObjectNav}\xspace}
\newcommand{\objnavfull}{ObjectGoal Navigation\xspace}
\newcommand{\pickplace}{\textsc{Pick\&Place}\xspace}
\newcommand{\objnavhd}{\textsc{ObjectNav-HD}\xspace}
\newcommand{\pickplacehd}{\textsc{Pick\&Place-HD}\xspace}
\newcommand{\obj}{{\tt <object>}\xspace}
\newcommand{\rec}{{\tt <receptacle>}\xspace}
\newcommand{\goal}{{\tt <goal\_object\_category>}\xspace}
\newcommand{\moveforward}{\textsc{move\_forward}\xspace}
\newcommand{\movebackward}{\textsc{move\_backward}\xspace}
\newcommand{\turnac}{\textsc{turn}\xspace}
\newcommand{\turnleft}{\textsc{turn\_left}\xspace}
\newcommand{\turnright}{\textsc{turn\_right}\xspace}
\newcommand{\lookup}{\textsc{look\_up}\xspace}
\newcommand{\lookdown}{\textsc{look\_down}\xspace}
\newcommand{\stopac}{\textsc{stop}\xspace}
\newcommand{\noop}{\textsc{no\_op}\xspace}
\newcommand{\grabrelease}{\textsc{grab\_release}\xspace}

\newcommand{\hmdval}{HM3D \textsc{val}\xspace}
\newcommand{\testchallenge}{\textsc{test-challenge}\xspace}
\newcommand{\teststd}{\textsc{test-standard}\xspace}

\newcommand{\movebase}{\textsc{MoveBase}\xspace}

%\newcommand{\datasetname}{\textsc{FindIt-52k}\xspace}
\newcommand{\datasetname}{\textsc{FindIt}\xspace}
\newcommand{\Tau}{\mathcal{T}}


\newcommand{\myquote}[1]{\emph{`#1'}}

\newcommand{\avgpool}{\textsc{2x2-AvgPool}\xspace}
...
% \newcommand{\ind}[1]{[\hspace{-1pt}[#1]\hspace{-1pt}] }
 \newcommand{\todo}[1]{\textcolor{red}{TODO: #1}}
 \newcommand{\outline}[1]{\textcolor{purple}{Outline: #1}}
 %\newcommand{\ram}[1]{\textcolor{orange}{Ram: #1}}
 \newcommand{\ram}[1]{\textcolor{orange}{#1}}
 \newcommand{\update}[1]{\textcolor{blue}{#1}}
 \newcommand{\question}[1]{\textbf{Question}: #1}
 \newcommand{\answer}[1]{\textbf{Answer}: \textcolor{blue}{#1}}

 % \newcommand{\Rone}[1]{\textcolor{BrickRed}{@7drB}}
 % \newcommand{\Rtwo}[1]{\textcolor{OliveGreen}{@rDzH}}
 % \newcommand{\Rthree}[1]{\textcolor{BlueViolet}{@nmuC}}
 \newcommand{\Rone}[1]{\textcolor{Bittersweet}{@7drB}}
 \newcommand{\Rtwo}[1]{\textcolor{LimeGreen}{@rDzH}}
 \newcommand{\Rthree}[1]{\textcolor{Cerulean}{@nmuC}}


% \newcommand{\red}[1]{\textcolor{red}{#1}}

% consistent bold starts
...
%%\textbf{Problem~\theproblem: #1}\rmfamily}
%\makeatother
...
%Motivation an VSN problem description.
\textcolor{red}{Can a robotic agent navigate and interact in the real world as seamlessly as humans do?
...
%Problem statement -> VSN is solved in a virtual world!
\textcolor{red}{Technically, in this work, we focus on embedding VSN models in real robotic platforms.
...
\begin{figure}[t]
    \centering
        \includegraphics[width=\linewidth]{abstract_paper}
        \caption{
...
\begin{enumerate}
 \item We first provide to the embodied agents community the ROS4VSN development, a novel Robot Operating System (ROS)~\cite{ros} based architecture that allows \textcolor{red}{testing and comparing} different VSN models in real robots.
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{arquitectura_paper}
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{comunicaciones_service}
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{move_robot_acceleration}
...
VSN models make decisions using mainly RGB images of the environment.
...
%\begin{figure}
%    \centering
%    \includegraphics[width=\linewidth]{VSN}
...
A configuration file is provided (\texttt{vsn.yaml}) containing default values for the parameters of our VSN package.
...
\begin{figure}
    ...
    \begin{subfigure}[b]{\textwidth}
        \includegraphics[width=\textwidth]{vlv_diagram}
        \caption{VLV model.}
        \label{fig:vlv_overview}
    \end{subfigure}
    ~
    \begin{subfigure}[b]{\textwidth}
        \includegraphics[width=\textwidth]{pirlnav_diagram}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\linewidth]{dataset_scene}
...
In order to integrate PIRLNav into our ROS4VSN architecture, we had to perform the following actions.
...
\textcolor{red}{One of the primary objectives of our work is to provide a comprehensive and clear protocol for the experimental evaluation of state-of-the-art VSN models in real-world scenarios using real robots.
...
\begin{figure}[t]
    \centering
        \includegraphics[width=\linewidth]{plano_vivienda}
...
\textcolor{red}{We encourage other researchers to conduct their experiments in real-world settings that are similar in size and characteristics, allowing the robot to navigate from at least 15 different starting positions across multiple instances.}

\textcolor{red}{From these positions, the robot is tasked with navigating to various object categories.
...
\begin{figure}
    ...
    \begin{subfigure}[b]{0.4\textwidth}
        \includegraphics[width=\textwidth,trim=3cm 0cm 3cm 0cm, clip]{turtlebot_2}
        \caption{Turtlebot 2.}
        \label{fig:robot_turtlebot}
    \end{subfigure}
    ~
    \begin{subfigure}[b]{0.4\textwidth}
        \includegraphics[width=\textwidth]{lola2}
...
\begin{figure}
    \centering
        \includegraphics[width=\linewidth]{hw-sw-scheme}
...
\textcolor{red}{We provide code to reproduce all our experiments at \url{https://github.com/gramuah/ros4vsn}.}
...
\begin{figure*}[t]
    \centering
        \makebox[\textwidth][c]{
        \includegraphics[width=1.2\linewidth]{vlv_qualitative}}
...
\begin{figure}
    \centering
        \makebox[\textwidth][c]{
        \includegraphics[width=1.2\linewidth]{pirlnav_qualitative}}
...
\begin{figure}[t]
    \centering
        \includegraphics[width=\linewidth]{histograma_PIRLNav}
...
\textcolor{brown}{The authors have no relevant financial or non-financial interests to disclose.} \\
\textcolor{brown}{This research is already publicly available on arXiv (\url{https://arxiv.org/abs/2311.16623}) as a pre-print.} \\
