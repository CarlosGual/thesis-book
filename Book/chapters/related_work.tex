...
\begin{figure}
    ...
    \caption{\textbf{Meta-Controller}: is a technique that avoids explicit gradient updates at test time by conditioning the policy on task-specific context, typically derived from demonstrations.
