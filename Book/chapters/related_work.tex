...
\lettrine{\textcolor{accent_color}{A}}{s} the fields of \acrlong{vsn} and \acrlong{rl} are very broad, this chapter aims to provide an extensive and organized overview of the most relevant works in the literature.
...
When \acrshort{il} is applied to the visual navigation problem, navigation policies are learned from expert demonstrations (\eg~\cite{ramrakhya2022,yadav2022}).
...
Overall, it is necessary to develop methods that allow efficient transfer of the knowledge learned in simulation to the real world.
