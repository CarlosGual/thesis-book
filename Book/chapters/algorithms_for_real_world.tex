...
\lettrine{\textcolor{accent_color}{W}}{hen} it comes to training robots to navigate in the real world, reinforcement learning (RL) has been the go-to approach for many years.
...
In this chapter, two alternative approaches to RL for robotic visual navigation are explored: Offline Reinforcement Learning and Meta Imitation Learning.
...
For the policy architecture, a simple CNN+RNN model from\cite{ramrakhya2023} is used.
